...
liste_aller_datein = os.listdir("kiki_web_scrap/newspapers/variety/")
pattern = r"\d+.*txt"
...
with open("kiki_web_scrap/newspapers/variety/"+neueste_link_txtdatei, 'r',  encoding="utf-8") as f:
    temp = f.readlines()
